...
// New TBD
func New(eventID []byte, relayURL []byte) *IdentifierTag {
...
// IdentifierTag is a tag for an event, including the event ID and relay URL.
...
// Encode encodes the IdentifierTag into a byte slice.
func (t *IdentifierTag) Encode() [][]byte {
	b := make([][]byte, 0)
...
func (t *IdentifierTag) Marshal() []byte {
